...
with open("C:\\Users\\uers\\Desktop\\MLGame-master\\2019-10-02_16-44-00.pickle", "rb") as f1:
    data_list1 = pickle.load(f1)
    #print(data_list1[0])
with open("C:\\Users\\uers\\Desktop\\MLGame-master\\2019-10-08_19-29-15.pickle", "rb") as f2:
    data_list2 = pickle.load(f2)
   # print(data_list2[0])
with open("C:\\Users\\uers\\Desktop\\MLGame-master\\2019-10-08_19-32-17.pickle", "rb") as f3:
    data_list3 = pickle.load(f3)
with open("C:\\Users\\uers\\Desktop\\MLGame-master\\2019-10-08_20-41-02.pickle", "rb") as f4:
    data_list4 = pickle.load(f4)  
    
with open("C:\\Users\\uers\\Desktop\\MLGame-master\\2019-10-08_20-42-40.pickle", "rb") as f5:
    data_list5 = pickle.load(f5)
    #print(data_list1[0])
with open("C:\\Users\\uers\\Desktop\\MLGame-master\\2019-10-08_20-44-46.pickle", "rb") as f6:
    data_list6 = pickle.load(f6)
   # print(data_list2[0])
with open("C:\\Users\\uers\\Desktop\\MLGame-master\\2019-10-08_20-37-32.pickle", "rb") as f7:
